...
function getItem(id) {
  return superagent__WEBPACK_IMPORTED_MODULE_0___default.a.get("".concat(itemsApi, "/item/").concat(id)).catch(function (err) {
    console.log(err.message);
  });
}
...
function editItem(id, item) {
  return superagent__WEBPACK_IMPORTED_MODULE_0___default.a.put("".concat(itemsApi, "/edit/").concat(id)).send(item).then(function (res) {
    console.log('success');
  }).catch(function (err) {
    console.log(err.message);
  });
...
function deleteItem(id) {
  return superagent__WEBPACK_IMPORTED_MODULE_0___default.a.delete("".concat(itemsApi, "/item/").concat(id)).then(function (res) {
    console.log('success');
  }).catch(function (err) {
    console.log(err.message);
  });
...
/* harmony import */ var _ItemsEdit__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ItemsEdit */ "./client/components/ItemsEdit.jsx");
/* harmony import */ var _ItemsDelete__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ItemsDelete */ "./client/components/ItemsDelete.jsx");
...
var App = function App(props) {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__["HashRouter"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__["Route"], {
    ...
    path: "/edit/:id",
    component: _ItemsEdit__WEBPACK_IMPORTED_MODULE_6__["default"]
  }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__["Route"], {
    path: "/delete/:id",
    component: _ItemsDelete__WEBPACK_IMPORTED_MODULE_7__["default"]
  }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__["Route"], {
    path: "/",
    component: _Footer__WEBPACK_IMPORTED_MODULE_8__["default"]
  })));
};
...
var Footer = function Footer() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "footer"
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "Made by Alisa"));
};
...
/* harmony default export */ __webpack_exports__["default"] = (GoHome);
...
var Header = function Header() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "header"
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", null, "Op Shopper"));
};
...
/***/ "./client/components/ItemTable.jsx":
/*!*****************************************!*\
  !*** ./client/components/ItemTable.jsx ***!
  \*****************************************/
/*! exports provided: default */
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-router-dom */ "./node_modules/react-router-dom/es/index.js");
/* harmony import */ var _Item__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Item */ "./client/components/Item.jsx");
...
function (_React$Component) {
  ...
  _createClass(Items, [{
    ...
    value: function componentDidMount() {
      ...
      _api__WEBPACK_IMPORTED_MODULE_3__["default"].getItems().then(function (response) {
        _this2.setState({
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../api */ "./client/api.js");
/* harmony import */ var _ItemTable__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ItemTable */ "./client/components/ItemTable.jsx");
/* harmony import */ var _GoHome__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./GoHome */ "./client/components/GoHome.jsx");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
/*#__PURE__*/
function (_React$Component) {
  _inherits(ItemsDelete, _React$Component);

  function ItemsDelete(props) {
    var _this;

    _classCallCheck(this, ItemsDelete);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ItemsDelete).call(this, props));
    _this.state = {
      item: {}
    };
    _this.handleClick = _this.handleClick.bind(_assertThisInitialized(_assertThisInitialized(_this)));
...
/***/ "./client/components/ItemsEdit.jsx":
/*!*****************************************!*\
  !*** ./client/components/ItemsEdit.jsx ***!
  \*****************************************/
/*! exports provided: default */
...
/*#__PURE__*/
function (_React$Component) {
  _inherits(ItemsEdit, _React$Component);

  function ItemsEdit(props) {
    var _this;

    _classCallCheck(this, ItemsEdit);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ItemsEdit).call(this, props));
    _this.state = {
      category: '',
      subcategory: '',
      item: '',
  ...
  _createClass(ItemsEdit, [{
    ...
    key: "handleClick",
    value: function handleClick(e) {
      _api__WEBPACK_IMPORTED_MODULE_1__["default"].editItem(this.props.match.params.id, this.state);
    }
  }, {
    key: "render",
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, "Edit item #", this.props.match.params.id), "Category:", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("select", {
        value: this.state.category,
        name: "category",
        onChange: this.handleChange
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("option", {
        ...
        onClick: this.handleClick
      }, "Edit Item"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_GoHome__WEBPACK_IMPORTED_MODULE_2__["default"], null));
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (ItemsEdit);

/***/ }),

/***/ "./client/components/ItemsOne.jsx":
/*!****************************************!*\
  !*** ./client/components/ItemsOne.jsx ***!
  \****************************************/
/*! exports provided: default */
...
/* harmony import */ var _ItemTable__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ItemTable */ "./client/components/ItemTable.jsx");
/* harmony import */ var _GoHome__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./GoHome */ "./client/components/GoHome.jsx");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
/*#__PURE__*/
function (_React$Component) {
  _inherits(ItemsOne, _React$Component);

  function ItemsOne(props) {
    var _this;

    _classCallCheck(this, ItemsOne);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ItemsOne).call(this, props));
    _this.state = {
      item: {}
    };
    return _this;
  ...
  _createClass(ItemsOne, [{
    ...
    value: function render() {
      var item = this.state.item;
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ItemTable__WEBPACK_IMPORTED_MODULE_3__["default"], {
        item: item
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__["Link"], {
        to: "/edit/".concat(item.id)
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", null, "Edit")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__["Link"], {
        to: "/delete/".concat(item.id)
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", null, "Delete")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_GoHome__WEBPACK_IMPORTED_MODULE_4__["default"], null));
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (ItemsOne);
